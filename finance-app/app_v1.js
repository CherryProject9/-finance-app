...
async function loadData() {
    if (!currentUser) return false;
    console.log("[FinanceOS] loadData starting...");
    ...
    try {
        ...
        // If BOTH the cloud and local storage are completely empty, restore the master backup.
        if ((!finalData.transactionsState || finalData.transactionsState.length === 0)) {
            console.log("🚀 Account empty or missing transactions. Restoring master backup.");
